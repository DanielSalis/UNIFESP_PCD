...
class GameThreadV2 extends Thread {

    int totalAlive;

    public GameThreadV2(int totalAlive) {
...
public class GameOfLifeThread {
    ...
    public int execute() {
        ...
        ArrayList<GameThreadV2> threads = new ArrayList<GameThreadV2>();
        
        for(int t=0; t<4; t++){
            GameThreadV2 gt = new GameThreadV2(totalAlive);
            for (i = 0; i < size; i++) {
                for (j = 0; j < size; j++) {
    ...
    public static void main(String[] args) {
        ...
        GameOfLifeThread G = new GameOfLifeThread();
